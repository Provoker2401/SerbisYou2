...
const PetGroomingSubcategoryRabb = () => {
  return (
    <View style={styles.petGroomingSubcategoryRabb}>
        ...
        <View style={styles.componentspropertyTypeParent}>
          ...
          <View style={[styles.frameGroup, styles.frameParentSpaceBlock]}>
            ...
            <View style={styles.frameContainer}>
              ...
              >
                <View style={styles.bathing350PerPetWrapper}>
                  <Text
                    style={[styles.bathing350PerContainer, styles.dogFlexBox]}
                  >
              ...
              <View style={[styles.frameParent2, styles.frameParentSpaceBlock]}>
                <View style={styles.bathing350PerPetWrapper}>
                  <Text
                    style={[styles.bathing350PerContainer, styles.dogFlexBox]}
                  >
                    <Text style={styles.dogTypo}>{`Fur Removal
`}</Text>
                    <Text style={[styles.perPet, styles.perPetTypo]}>
                      ₱400 per pet
                    </Text>
              ...
              <View style={[styles.frameParent2, styles.frameParentSpaceBlock]}>
                <View style={styles.bathing350PerPetWrapper}>
                  <Text
                    style={[styles.bathing350PerContainer, styles.dogFlexBox]}
                  >
                    <Text style={styles.dogTypo}>{`Scent Gland Cleaning
`}</Text>
                    <Text style={[styles.perPet, styles.perPetTypo]}>
                      ₱600 per pet
                    </Text>
              ...
              <View style={[styles.frameParent2, styles.frameParentSpaceBlock]}>
                <View style={styles.bathing350PerPetWrapper}>
                  <Text
                    style={[styles.bathing350PerContainer, styles.dogFlexBox]}
                  >
                    <Text style={styles.dogTypo}>{`Eye Cleaning
`}</Text>
                    <Text style={[styles.perPet, styles.perPetTypo]}>
                      ₱300 per pet
                    </Text>
...
const styles = StyleSheet.create({
  ...
  bathing350PerContainer: {
    color: Color.colorTypographyContentIconsBlack,
  },
  bathing350PerPetWrapper: {
    flexDirection: "row",
    flex: 1,
  },
  added: {
...
export default PetGroomingSubcategoryRabb;
