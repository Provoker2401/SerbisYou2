...
const PetSittingSubcategoryBird = () => {
  return (
    <View style={styles.petSittingSubcategoryBird}>
        ...
        <View style={styles.componentspropertyTypeParent}>
          ...
          <View style={[styles.frameGroup, styles.frameParentSpaceBlock]}>
            ...
            <View style={styles.frameContainer}>
              <View style={[styles.petSittingWrapper, styles.petParentFlexBox]}>
                <View style={styles.feedingAndWatering350PerWrapper}>
                  <Text
                    style={[
...
`}</Text>
              ...
              <View style={[styles.frameParent2, styles.frameParentSpaceBlock]}>
                <View style={styles.feedingAndWatering350PerWrapper}>
                  ...
                  >
                    <Text style={styles.dogTypo}>{`Bird Massage
`}</Text>
                    <Text style={[styles.perDay, styles.perDayTypo]}>
                      ₱100 per hour
                    </Text>
              ...
              <View style={[styles.frameParent2, styles.frameParentSpaceBlock]}>
                <View style={styles.feedingAndWatering350PerWrapper}>
                  ...
                  >
                    <Text style={styles.dogTypo}>{`Interactive Socialization
`}</Text>
                    <Text style={[styles.perDay, styles.perDayTypo]}>
                      ₱200 per day
                    </Text>
              ...
              <View style={[styles.frameParent2, styles.frameParentSpaceBlock]}>
                <View style={styles.feedingAndWatering350PerWrapper}>
                  ...
                  >
                    <Text style={styles.dogTypo}>{`Outdoor Exploration
`}</Text>
                    <Text style={[styles.perDay, styles.perDayTypo]}>
                      ₱250 per day
                    </Text>
...
const styles = StyleSheet.create({
  ...
  feedingAndWatering350PerWrapper: {
    flexDirection: "row",
    flex: 1,
  },
  added: {
...
export default PetSittingSubcategoryBird;
