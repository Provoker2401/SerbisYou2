...
const openModalWithData = () => {
  ...
  return (
    <View style={styles.carpentryFurnitureSubcategor}>
      ...
      >
        <View
          style={[
            styles.furnitureAssemblyAndDisasseWrapper,
            styles.btnWrapperFlexBox,
          ]}
        >
          <Text style={styles.furnitureAssemblyAnd}>
        ...
        <View
          ...
          <View style={[styles.frameGroup, styles.frameParentSpaceBlock]}>
            ...
            <View style={styles.frameContainer}>
              ...
              >
                <View style={styles.desk800Per24InchesX48IWrapper}>
                  <Text style={styles.desk800PerContainer}>
                    <Text style={styles.desk}>{`Desk
`}</Text>
                    <Text style={[styles.per24Inches, styles.per24InchesTypo]}>
                      ₱{desk} per 24 inches x 48 inches
                    </Text>
                  </Text>
                  {areaVisible1 ? (
                      <View>
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.desk800Per24InchesX48IWrapper}>
                  <Text style={styles.desk800PerContainer}>
                    <Text style={styles.desk}>{`Cabinet
`}</Text>
                    <Text style={[styles.per24Inches, styles.per24InchesTypo]}>
                      ₱{cabinet} per 36 inches x 26 inches
                    </Text>
                  </Text>
                </View>
                {areaVisible2 ? (
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.desk800Per24InchesX48IWrapper}>
                  <Text style={styles.desk800PerContainer}>
                    <Text style={styles.desk}>{`Wardrobe
`}</Text>
                    <Text style={[styles.per24Inches, styles.per24InchesTypo]}>
                      ₱{wardrobe} per 1.5m x 1.85m
                    </Text>
                  </Text>
                </View>
                {areaVisible3 ? (
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.desk800Per24InchesX48IWrapper}>
                  <Text style={styles.desk800PerContainer}>
                    <Text style={styles.desk}>{`Bed
`}</Text>
                    <Text style={[styles.per24Inches, styles.per24InchesTypo]}>
                      ₱{bed} per 76 inches x 80 inches
                    </Text>
                  </Text>
                </View>
                {areaVisible4 ? (
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.desk800Per24InchesX48IWrapper}>
                  <Text style={styles.desk800PerContainer}>
                    <Text style={styles.desk}>{`Bookshelf
`}</Text>
                    <Text style={[styles.per24Inches, styles.per24InchesTypo]}>
                      ₱{bookshelf} per 40 inches x 22 inches
                    </Text>
                  </Text>
                </View>
                {areaVisible5 ? (
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.desk800Per24InchesX48IWrapper}>
                  <Text style={styles.desk800PerContainer}>
                    <Text style={styles.desk}>{`Chair
`}</Text>
                    <Text style={[styles.per24Inches, styles.per24InchesTypo]}>
                      ₱{chair} per 40 inches x 20 inches
                    </Text>
                  </Text>
                </View>
                {areaVisible6 ? (
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.desk800Per24InchesX48IWrapper}>
                  <Text style={styles.desk800PerContainer}>
                    <Text style={styles.desk}>{`Table
`}</Text>
                    <Text style={[styles.per24Inches, styles.per24InchesTypo]}>
                      ₱{table} per 45 inches x 25 inches
                    </Text>
                  </Text>
                </View>
                {areaVisible7 ? (
...
const styles = StyleSheet.create({
  ...
  furnitureAssemblyAndDisasseWrapper: {
    alignItems: "center",
    alignSelf: "stretch",
  },
  tag: {
...
export default CarpentryFurnitureSubcategor;