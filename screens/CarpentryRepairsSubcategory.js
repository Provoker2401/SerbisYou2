...
const CarpentryRepairsSubcategory = ({ route }) => {
...
const servicePrices = {
  ...
  wallersRepair: wall,
  tilersRepair: tile,
  windowingRepair: window,
  doorlocksydaisyRepair: doorlock,
  gutteredRepair: gutter,
  gatersRepair: gate,
  doorbellersRepair: doorbell,
  secuCamRepair: securitycam,
};


const inputValues = [
  { name: "Roofing", value: input1Value, service: "roofRepair" },
  { name: "Wall", value: input2Value, service: "wallersRepair" },
  { name: "Tile", value: input3Value, service: "tilersRepair" },
  { name: "Window", value: input4Value, service: "windowingRepair" },
  { name: "Door and Door Lock", value: input5Value, service: "doorlocksydaisyRepair" },
  { name: "Gutter", value: input6Value, service: "gutteredRepair" },
  { name: "Gate/Fence", value: input7Value, service: "gatersRepair" },
  { name: "Doorbell", value: input8Value, service: "doorbellersRepair" },
  { name: "Security Cameras", value: input9Value, service: "secuCamRepair" },
];
...
const openModalWithData = () => {
  ...
  return (
    <View style={styles.carpentryRepairsSubcategory}>
...
export default CarpentryRepairsSubcategory;