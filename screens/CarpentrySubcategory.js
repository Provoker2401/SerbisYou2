...
const CarpentrySubcategory = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.carpentrySubcategory, styles.uiIconlistfilledLayout]}>
          ...
          <View style={styles.componentsserviceListInner}>
            <View style={[styles.frameGroup, styles.backFrameFlexBox]}>
              <View style={[styles.backBtnParent, styles.backFrameFlexBox]}>
                ...
                <Text style={[styles.carpentry, styles.carpentryTypo]}>
                  Carpentry
                </Text>
              </View>
          ...
          <View style={styles.stFrameWrapper}>
            <View style={styles.stFrame}>
              ...
              <Pressable
                ...
                onPress={() =>
                  navigation.navigate("CarpentryInstallationSubcate")
                }
              >
                ...
                <View style={[styles.frameContainer, styles.numberSpaceBlock]}>
                  <View style={styles.stFrame}>
                    <View style={styles.backFrameFlexBox}>
                      <Text style={[styles.installation, styles.carpentryTypo]}>
                        Installation
                      </Text>
                    </View>
                  </View>
...
export default CarpentrySubcategory;
