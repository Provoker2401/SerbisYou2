...
const ElectricalInstallationSubcat = () => {
    ...
    getDoc(subCollectionRef)
      .then((docSnapshot) => {
        if (docSnapshot.exists()) {
          ...
          setlightFixtures(installationData.lightFixtures);
          setswitchPrice(installationData.switch);
          setpanelPrice(installationData.panel);
          setcctvPrice(installationData.cctv);
          setfireAlarmPrice(installationData.fire);
          setsmokePrice(installationData.smoke);
        } else {
  ...
  return (
    <View style={styles.electricalInstallationSubcat}>
...
export default ElectricalInstallationSubcat;
