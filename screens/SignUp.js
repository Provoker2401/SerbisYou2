...
//       phoneData: `+63${phone}`,
//     });
//     console.log("User Details: ", addUserDetails);
...
import Toast from 'react-native-toast-message';
import { FontSize, FontFamily, Color, Padding, Border } from "../GlobalStyles";
import { getAuth, createUserWithEmailAndPassword, PhoneAuthProvider } from 'firebase/auth';
// import {getApp } from "../App";
import {
  getFirestore,
  doc,
...
const SignUp = () => {
  ...
  //     const db = getFirestore();
  //     const userDocRef = doc(db, 'userProfiles', userUid);
  //     const userBookingsRef = doc(db, 'serviceBookings', userUid);
  ...
  //       );
  //       console.log("OG Verification Id: " , verificationId);
  ...
  //     console.log("let verification ID:", verifyID);

  //     // Continue with navigation
  //     navigation.navigate("Authentication", {
  //       email: email,
  //       password: password,
  //       verificationId: verifyID  // Passed directly
  //     });
  //   } catch (error) {
  //     console.error('Sign-up error:', error);
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      const phoneQuery  = query(usersCollectionRef, where("phone", "==", `+63${phone}`));
      ...
      console.log("Sign Up Current User Email: ", currentUser.email);
