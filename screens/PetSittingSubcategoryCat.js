...
const PetSittingSubcategoryCat = () => {
  return (
    <View style={styles.petSittingSubcategoryCat}>
              ...
              <View style={styles.customer}>
                ...
                <View style={[styles.customer2, styles.frameParentSpaceBlock]}>
                  ...
                  >
                    ...
                    <View style={[styles.iconOutline1, styles.iconPosition1]}>
                      <Image
                        style={[styles.whiteCatIcon, styles.whiteIconPosition]}
                        contentFit="cover"
                  ...
                  <View style={styles.customerInner}>
                    ...
                    >
                      ...
                      <Pressable
                        style={[styles.addBtn1, styles.addInnerFlexBox]}
                      >
                        <Image
                          style={styles.add2Icon}
                          contentFit="cover"
...
`}</Text>
              ...
              <View style={[styles.frameParent2, styles.frameParentSpaceBlock]}>
                <View style={styles.feedingAndWatering450PerWrapper}>
                  ...
                  >
                    <Text style={styles.dogTypo}>{`Potty Breaks
`}</Text>
                    <Text style={[styles.perDay, styles.perDayTypo]}>
                      ₱350 per day
                    </Text>
...
export default PetSittingSubcategoryCat;
