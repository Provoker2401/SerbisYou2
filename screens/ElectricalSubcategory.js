...
const ElectricalSubcategory = () => {
  ...
  return (
    <View style={[styles.electricalSubcategory, styles.uiIconlistfilledLayout]}>
        ...
        <View style={styles.componentsserviceList}>
          <View style={styles.componentsserviceListInner}>
            <View style={[styles.frameGroup, styles.backFrameFlexBox]}>
              <View style={[styles.backBtnParent, styles.backFrameFlexBox]}>
                ...
                <Text style={[styles.electrical, styles.electricalTypo]}>
                  Electrical
                </Text>
              </View>
          ...
          <View style={styles.stFrameWrapper}>
            <View style={styles.stFrame}>
              ...
              <Pressable
              testID = "electricalInstallationBtn"
                style={[
                  styles.electricalInstallationBtn,
                  styles.backFrameFlexBox,
                ]}
                onPress={() =>
                  navigation.navigate("ElectricalInstallationSubcat")
                }
              >
                ...
                <View style={[styles.frameContainer, styles.numberSpaceBlock]}>
                  <View style={styles.stFrame}>
                    <View style={styles.backFrameFlexBox}>
                      <Text
                        style={[styles.installation, styles.electricalTypo]}
                      >
                        Installation
                      </Text>
                    </View>
          ...
          <View style={styles.stFrameWrapper}>
            <View style={styles.stFrame}>
              <Pressable
              testID = "electricalRepairsBtn"
                style={[styles.frameGroup, styles.backFrameFlexBox]}
                onPress={() =>
                  navigation.navigate("ElectricalRepairsSubcategory")
                }
              >
                <View style={styles.frame}>
                  <Image
