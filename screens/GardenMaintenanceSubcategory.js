...
const GardenMaintenanceSubcategory = () => {
  ...
  const [mulching, setMulching] = useState(null);
  const [fertilizing, setFertilizing] = useState(null);
  const [mowing, setMowing] = useState(null);
  const [aerating, setAerating] = useState(null);
  const [weedRemoval, setWeedRemoval] = useState(null);
    ...
    getDoc(subCollectionRef)
      .then((docSnapshot) => {
        if (docSnapshot.exists()) {
          ...
          setPruning(DeepData.pruningtrimming);
          setMulching(DeepData.mulching);
          setFertilizing(DeepData.fertilizing);
          setMowing(DeepData.mowing);
          setAerating(DeepData.aerating);
          setWeedRemoval(DeepData.weedremoval);
        } else {
  ...
  const multipliedValue =
    parseInt(input1Value) * pruning +
    parseInt(input2Value) * mulching +
...
const openModalWithData = () => {
  ...
  return (
    <View style={styles.gardenMaintenanceSubcategory}>
      ...
      >
        <View style={[styles.gardenMaintenanceWrapper, styles.wrapperFlexBox]}>
          <Text style={styles.gardenMaintenance}>Garden Maintenance</Text>
        </View>
        <View style={styles.componentspropertyTypeParent}>
          ...
          <View
            style={[
              styles.componentsgardeningMaterials,
          ...
          <View style={[styles.frameGroup, styles.frameParentSpaceBlock]}>
            <View style={styles.tagParent}>
              ...
              <Text style={[styles.gardenSize, styles.gardenSizeFlexBox]}>
                Type of Garden Maintenance
              </Text>
            </View>
            <View style={styles.frameContainer}>
              <View
                style={[styles.gardenMaintenanceWrapper, styles.wrapperFlexBox]}
              >
                <View style={styles.pruningAndTrimming300PerWrapper}>
                  <Text
                    style={[
                      styles.pruningAndTrimmingContainer,
                      styles.gardenSizeFlexBox,
                    ]}
                  >
                    <Text
                      style={styles.pruningAndTrimming}
...
`}</Text>
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.pruningAndTrimming300PerWrapper}>
                  ...
                  >
                    <Text style={styles.pruningAndTrimming}>{`Mulching
`}</Text>
                    <Text style={[styles.perService, styles.sqMTypo]}>
                      ₱{mulching} per service
                    </Text>
                  </Text>
                </View>
                {areaVisible2 ? (
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.pruningAndTrimming300PerWrapper}>
                  ...
                  >
                    <Text style={styles.pruningAndTrimming}>{`Fertilizing
`}</Text>
                    <Text style={[styles.perService, styles.sqMTypo]}>
                      ₱{fertilizing} per service
                    </Text>
                  </Text>
                </View>
                {areaVisible3 ? (
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.pruningAndTrimming300PerWrapper}>
                  ...
                  >
                    <Text style={styles.pruningAndTrimming}>{`Mowing
`}</Text>
                    <Text style={[styles.perService, styles.sqMTypo]}>
                      ₱{mowing} per service
                    </Text>
              ...
              <View style={[styles.frameParent1, styles.frameParentSpaceBlock]}>
                <View style={styles.pruningAndTrimming300PerWrapper}>
                  ...
                  >
                    <Text style={styles.pruningAndTrimming}>{`Aerating
`}</Text>
                    <Text style={[styles.perService, styles.sqMTypo]}>
                      ₱{aerating} per service
                    </Text>
                  </Text>
                </View>
                {areaVisible5 ? (
...
const styles = StyleSheet.create({
  ...
  addBtnInner1: {
   ...
   // Do not include to copy the styles below adadaddddddddddddddddddd sdfsdfsdfsdf
  ...
  pruningAndTrimmingContainer: {
    color: Color.colorTypographyContentIconsBlack,
  },
  pruningAndTrimming300PerWrapper: {
    flexDirection: "row",
    flex: 1,
  },
  added: {
...
export default GardenMaintenanceSubcategory;