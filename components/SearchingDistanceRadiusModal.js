...
// const SearchingDistanceRadiusModal = ({ cityAddress, specificLocation }) => {
...
//       </View>
//       {/* <View
//         style={[styles.componentsSearchDefault, styles.addressDetailsBtnBg]}
//       >
...
//           <Text style={styles.uscTalamban}>{cityAddress}</Text>
//           <Text
//             style={[
//               styles.barangayNasipitTalamban,
...
//           <View
//             style={[styles.whiteBookmarkParent, styles.componentsbuttonFlexBox]}
//           >
//             <Image
//               style={[styles.whiteBookmarkIcon, styles.bookmarkIconPosition]}
//               contentFit="cover"
//               source={require("../assets/white-bookmark.png")}
//             />
//             <Image
//               style={[styles.grayBookmarkIcon, styles.bookmarkIconPosition]}
//               contentFit="cover"
...
//         </View>
//       </View>
//       <View style={[styles.componentsSearchDefault1, styles.componentsFlexBox]}>
//         <Pressable
//           style={[styles.addressDetailsBtn, styles.addressDetailsBtnBg]}
//         >
//           <View style={styles.addressDetailsFrame}>
//             <Text
//               style={[styles.addAddressDetails, styles.addAddressDetailsClr]}
//             >
...
//           onPress={() => navigation.navigate("ReviewSummary",{sliderValue})}
//         >
