...
const Header24 = ({ style }) => {
  ...
  return (
    <SafeAreaView style={[styles.header, style]}>
      <View style={[styles.view, styles.viewFlexBox41]}>
        ...
        <View style={[styles.addToSavedPlacesWrapper, styles.viewFlexBox41]}>
          <Text style={styles.addToSaved}>Add to Saved Places</Text>
        </View>
      </View>
    </SafeAreaView>
  );
