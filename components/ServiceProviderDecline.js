      ...
      <View style={styles.content}>
        ...
        <View style={styles.text}>
          <View style={styles.text}>
            ...
            >
              Service Provider Declined the Booking
            </Text>
            <Text
              style={[
            ...
            >
              The service provider has declined your booking request. Please try
              another service provider or adjust your booking details.
            </Text>
          </View>
          <Pressable
            style={styles.okBtn}
