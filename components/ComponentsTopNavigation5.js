...
const ComponentsTopNavigation5 = ({ style }) => {
  const navigation = useNavigation();

  return (
    <SafeAreaView style={[styles.componentstopNavigation, style]}>
      <View style={[styles.view, styles.backParentFlexBox2]}>
        <View style={[styles.frameParent, styles.backParentFlexBox2]}>
          <View style={[styles.backBtnParent, styles.backParentFlexBox2]}>
            <Pressable
              style={[styles.backBtn, styles.backParentFlexBox2]}
          ...
          <Pressable style={[styles.searchBtn, styles.backParentFlexBox2]}>
...
export default ComponentsTopNavigation5;
