...
const ComponentsTopNavigation4 = ({ style }) => {
  const navigation = useNavigation();

  return (
    <SafeAreaView style={[styles.componentstopNavigation, style]}>
      <View style={[styles.view, styles.backParentFlexBox1]}>
        <View style={[styles.frameParent, styles.backParentFlexBox1]}>
          <View style={[styles.backBtnParent, styles.backParentFlexBox1]}>
            <Pressable
              style={[styles.backBtn, styles.backParentFlexBox1]}
          ...
          <Pressable style={[styles.searchBtn, styles.backParentFlexBox1]}>
...
export default ComponentsTopNavigation4;
