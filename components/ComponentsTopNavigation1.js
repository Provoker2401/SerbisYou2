...
const ComponentsTopNavigation1 = ({ style }) => {
  const navigation = useNavigation();

  return (
    <SafeAreaView style={[styles.componentstopNavigation, style]}>
      <View style={[styles.view, styles.backParentFlexBox5]}>
        <View style={[styles.frameParent, styles.backParentFlexBox5]}>
          <View style={[styles.backBtnParent, styles.backParentFlexBox5]}>
            <Pressable
              style={[styles.backBtn, styles.backParentFlexBox5]}
          ...
          <Pressable style={[styles.searchBtn, styles.backParentFlexBox5]}>
...
export default ComponentsTopNavigation1;
