...
// //   const [particularLocation, setParticularLocation] =
// //     useState(specificLocation);
// //   const [particularCity, setParticularCity] = useState(cityAddress);
...
// //   const handleAddToList = async (category, value) => {
...
// //         const tempSavedOptions = [
// //           {
// //             address: selectedLocation,
// //             floor: updatedFloorInput,
// //             houseNumber: updatedHouseNumberInput,
// //             label: updatedLabelInput,
// //             note: updatedNoteInput,
// //             street: updatedStreetInput,
// //             value: selectedValue,
// //           },
// //         ];
...
// //               optionsData.savedOptions[selectedValue - 1] = tempSavedOptions[0];
...
// //         //   console.log("Street: " ,doc.street);
// //         //   console.log("Floor: " ,doc.floor);
// //         // });
...
// //                       : selectedLocation
// //                   }
// //                   {/* {checkMarkerChange ? specificLocation : selectedLocation} */}
// //                 </Text>
// //                 <Text style={[styles.cebu, styles.cebuClr]}>{added ? addedCityAddress : selectedCity ? selectedCity : cityAddress}</Text>
// //               </View>
// //               {!body && (
// //                 <View style={styles.componentsSearchDefaultInner}>
// //                   <View style={[styles.pencil1Wrapper, styles.pencil1Position]}>
// //                     <Image
...
// //         </View>
// //       )}
// //       {searchModal && <SearchAddressModal addOrEdit={addOrEdit} />}
// //     </View>
// //   );
// // }
...
//             houseNumber: updatedHouseNumberInput,
//             label: updatedLabelInput,
//             otherLabel: updatedOtherLabelInput,
//             note: updatedNoteInput,
//             street: updatedStreetInput,
//             coordinates: selectedCoordinates,  // Preserve coordinates
//             value: selectedValue,
//           },
//         ];
...
//                         // onClick={() => setIsTextInputClicked(true)}
//                       />
//                     </ScrollView>
//                   </View>
//                 </View>
...
//                     style={[styles.noteInput, styles.textTypo]}
//                     placeholder={
//                       selectedOtherLabel ? selectedOtherLabel : "e.g. Office, Lobby, Villa, etc."
//                     }
//                     placeholderTextColor={selectedOtherLabel ? "#000" : "#b8b8b8"}
...
export default function EditAddressModal({
  ...
  // const handleStreetInputChange = (text) => {
  //   if (text.length <= 300) {
  //     setTextInputStreet(text);
  //   }
  // };
  // const handleHouseNumberInputChange = (text) => {
  //   if (text.length <= 300) {
  //     setTextInputHouseNumber(text);
  //   }
  // };
  // const handleFloorInputChange = (text) => {
  //   if (text.length <= 300) {
  //     setTextInputFloor(text);
  //   }
  // };
  ...
  const handlePlaceSelect = (data, details = null) => {
    ...
    if (details) {
      ...
      navigation.navigate('AddNewAddress', { placeName }); // Corrected line
  ...
  const handleBackButton = () => {
    ...
    console.log("Search modal is: ", searchModal);

    console.log("add and edit is", addOrEdit);
  };
  ...
  return (
    <View style={styles.editAddressModal}>
      ...
      <View style={styles.editAddressModalSearch}>
        {searchModal && (
          <View style={styles.frameGroupSearch}>
            <View style={styles.frameContainerSearch}>
              <View style={styles.frameFlexBox1Search}>
                <View
                  style={[
                    styles.vectorWrapper1Search,
                    styles.btnWrapperFlexBoxSearch,
                  ]}
                >
                  <Image
                    style={styles.frameChildSearch}
                    contentFit="cover"
                    source={require("../assets/line-76.png")}
                  />
                </View>
              </View>
              <View style={styles.frameContainer1Search}>
                <View
                  style={[
                    styles.componentsSearchDefaultWrapperSearch,
                    styles.btnWrapperFlexBoxSearch,
                  ]}
                >
                  <View
                    style={[
                      styles.componentsSearchDefault3Search,
                      styles.btnWrapperFlexBoxSearch,
                    ]}
                  >
                    <Pressable
                      style={[
                        styles.iconOutline1Search,
                        styles.btnWrapperFlexBoxSearch,
                      ]}
                    ...
                    >
                      <Image
                        style={[
                          styles.uiIconarrowBackwardfilled1Search,
                          styles.locationTargetIconLayoutSearch,
                        ]}
                        contentFit="cover"
                    ...
                    <View
                      style={[
                        styles.componentsSearchDefault2Search,
                        styles.btnWrapperFlexBoxSearch,
                      ]}
                    >
                      <GooglePlacesAutocomplete
                        ...
                        renderRightButton={() =>
                          showCloseBtn && (
                            <TouchableOpacity
                              ...
                              style={styles.backBtnWrapperSearch}
                            >
                              <Image
              ...
              <View style={[styles.frameViewSearch, styles.frameFlexBoxSearch]}>
                <View
                  style={[
                    styles.vectorWrapper1Search,
                    styles.btnWrapperFlexBoxSearch,
                ...
                >
                  <Image
                    style={[styles.frameItem1Search, styles.frameLayoutSearch]}
                    contentFit="cover"
              ...
              {showExploreContainer ? (
                <View style={styles.frameParent1Search}>
                  <View style={styles.image2397Wrapper}>
                    <Image
                      style={styles.image2397IconSearch}
                      contentFit="cover"
                  ...
                  <View
                    style={[
                      styles.enterAnAddressToExploreSeWrapperSearch,
                      styles.btnWrapperFlexBoxSearch,
                    ]}
                  >
                    <Text
                      style={[
                        styles.enterAnAddressSearch,
                        styles.btnWrapperFlexBoxSearch,
                      ]}
                    >
                      Enter an address to explores service providers around you
                    </Text>
                  </View>
                </View>
              ) : (
                <View style={styles.hiddenFrameSearch}>
                  <View style={styles.frameParent2Search}>
                    <View style={styles.image2397Wrapper}>
                      <Image
                        style={styles.image2397IconSearch}
                        contentFit="cover"
