...
const ComponentsTopNavigation6 = ({ style }) => {
  const navigation = useNavigation();

  return (
    <SafeAreaView style={[styles.componentstopNavigation, style]}>
      <View style={[styles.view, styles.backParentFlexBox3]}>
        <View style={[styles.frameParent, styles.backParentFlexBox3]}>
          <View style={[styles.backBtnParent, styles.backParentFlexBox3]}>
            <Pressable
              style={[styles.backBtn, styles.backParentFlexBox3]}
          ...
          <Pressable style={[styles.searchBtn, styles.backParentFlexBox3]}>
...
export default ComponentsTopNavigation6;
